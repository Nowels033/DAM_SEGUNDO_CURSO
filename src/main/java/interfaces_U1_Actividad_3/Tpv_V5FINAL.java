...
public class Tpv_V5FINAL extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tpv_V5FINAL frame = new Tpv_V5FINAL();
	...
	public Tpv_V5FINAL() {
		...
		tablaMesas.setModel(new DefaultTableModel(new Object[][] {}, new String[] {}));
		...
		JButton btnOkModificar = new JButton("OK");

		btnOkModificar.setBounds(614, 438, 225, 37);
		btnOkModificar.setVisible(false);
		aniadir.add(btnOkModificar);
		...
		btnModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fila >= 0) {
					...
					modificar = true;
					productoModificar = (String) Metodos.seleccionarModeloDeTabla(numeroDeModelo, modelos)
							.getValueAt(fila, 0);
					tipoModificar = (String) Metodos.seleccionarModeloDeTabla(numeroDeModelo, modelos).getValueAt(fila,
							1);
					cantidadModificar = (String) Metodos.seleccionarModeloDeTabla(numeroDeModelo, modelos)
							.getValueAt(fila, 2);

					numProductos.setValue(Integer.parseInt(cantidadModificar));
					btnOk.setVisible(false);
					btnOkModificar.setVisible(true);
					buttonGroup.clearSelection();
					buttonGroup_1.clearSelection();
		...
		// LISTENER OK MODIFICAR
		btnOkModificar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Metodos.seleccionarModeloDeTabla(numeroDeModelo, modelos).insertRow(fila, aniadirTabla);
				Metodos.seleccionarModeloDeTabla(numeroDeModelo, modelos).removeRow(fila+1);
...
//		btnVolver2.action(null, iconosTipoProducto);
		// LISTENER AÑADIR
